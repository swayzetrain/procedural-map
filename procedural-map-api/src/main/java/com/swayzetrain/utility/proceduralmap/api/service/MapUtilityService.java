...
public class MapUtilityService {
	...
	public Coordinate findCoordinateofGivenType(Integer[][] map, TileType tileType) {
		...
		if (map[coordinate.getY()][coordinate.getX()] == tileType.getValue()) {
			...
			return findCoordinateofGivenType(map, tileType);
		}
	}

	public Coordinate findCoordinateofGivenType(Integer[][] map, RandomizationService randomizationService,
			TileType tileType) {
